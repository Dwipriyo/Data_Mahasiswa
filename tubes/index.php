    ...
    <div class="content">
        <div class="card-login">
            <div class="card-main">
                ...
                <div class="card-body">
                    <form class="form-login" method="POST" action="<?= 'http://tubes.com/process/process_login.php' ?>">
                    ...
                    <p style="text-align: center;">Belum punya akun?<span><a href="<?= "http://tubes.com/register.php" ?>" class=""> Daftar disini</a></span></p>
                </div>
            </div>
        </div>
    </div>
